...
# bin/hdfs dfs -rm -r /kmer/input/result
# ~/Downloads/hadoop/bin/hdfs dfs -get /wc/input/wc_result ~/Documents/sg/MPI-Exercises/spark_ex7/output2/
# ~/Downloads/hadoop/bin/hdfs dfs -get /kmer/input/result ~/Documents/sg/MPI-Exercises/spark_ex7/output2/
